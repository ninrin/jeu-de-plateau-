$(document).ready(function () {
	...
	// On appelle les methode de mise en placement et de déplacement des 2 joueurs.
	personnage1.set(personnage2);
	personnage2.set(personnage1);
	personnage1.deplacement(personnage2);
	personnage2.deplacement(personnage1);
	...
	// on cache les bouttons de combat/défense par défaut pour les 2 joueurs
	$("#fight1").hide();
	$("#defendre1").hide();
	$("#fight2").hide();
	$("#defendre2").hide();
	...
	//madara commence en cachant le block d'hashirama
	$("#block2").hide();
	$("#block1").show();



	// mise en fin de tour, pour chaque boutton "passer son tour" correspondant.
